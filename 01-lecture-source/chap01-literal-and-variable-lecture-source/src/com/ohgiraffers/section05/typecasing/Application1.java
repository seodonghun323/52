...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 데이터의 형변환이 필요한 이유
         * - 자바에서 다른 타입끼리 연산은 피연사자들이 모두 같은 타입인 경우 실행할 수 있따.
         * -즉, 같은 데이터 타입끼리만 연산을 수행할 수 있다.
         * */
        /*형변환의 종류와 규칙*/
        /* 1. 자동형변환(묵시적 형변환) : 컴파일러가 자동으로 수행해주는 타입 변환
         *   1-1. 작은 자료형에 큰 자료형으로 자동 형변환 된다
        ...
        //int result = num1 + num2;     //자동으로 큰 자료형인 long타입으로 변경 후에 계산하기 때문에 int형 변수로 값을 담을 수 없다
        long result1 = num1 + num2; // int + long은 다른 자료형이라 데이터 손실이 발생하지 않는 int > ling 변환을 자동으로 수행 후 연산한다
