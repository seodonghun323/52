...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /*
        * 메소드란?
        * 메소드(method)는 어떤 특정 작업을 수행하기 위한 명령문의 집함
        *
        * 메소드 사요목적
        ...
        * */
        ...
        /* 1.main method 밖에 하단에 mrthodA라는 메소드를 추가한다. */
    ...
    public void methodB() {
        ...
        System.out.println("6시 20분에 수업을 시작합니다");
    ...
    public void methodC(){
        ...
        System.out.println("점심시간 끝 2시 30분입니다");
    }

    public void methodD(){

        System.out.println("잠자기쿨쿨");
        System.out.println("잠자기쿨쿨");
        System.out.println("잠자기쿨쿨");
