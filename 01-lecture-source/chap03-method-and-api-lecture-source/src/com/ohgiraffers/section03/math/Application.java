...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * API란?
        * Application programming Interface는 응용프로그램에서 사용할 수 이도록
        * 운영체제나 프로그래밍 언어가 제공하는 기능을 제어할 수 이도록 만든 인터페이스를 뜻한다.
        ...
        * (객체의 상태를 관리하지 않고 기능만을 제공하는 경우 메모리를 효율적으로 사용하기 위해 자구 사용되는 기법이다.*/
