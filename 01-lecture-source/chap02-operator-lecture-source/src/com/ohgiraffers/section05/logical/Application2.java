...
public class Application2 {
    ...
    public static void main(String[] args){
        ...
        * && : 11순위
        * || : 12순위
        * 논리 and 연산자 우선순위가 논리or 우선순위보다 높다*/


        /* 1. 1부터 100 사이의 값인지 확인*/
        /* 1<= 변수 <= 100 이렇게는 사용 못함 --> 변수 >=100 이렇게 사용해야 한다*/
        int num1 = 55;
        ...
        char ch1 = 'g';
        System.out.println("영어의 소문자인지 확인 : " + (ch1 >= 'A' && ch1 <= 'Z'));

        /* 3. 대소문자와 상관없이 영문자 y인지 확인*/
        /* 문자변수 == 'y' || 문자변수 =='Y'*/
        char ch2 = 'y';
        System.out.println("영어의 소문자인지 확인 : " + (ch2 >= 'y' || ch2 == 'Y'));


        char ch3 = 'Y';
        System.out.println("영어의 소문자인지 확인 : " + (ch3 == 'y' || ch3 == 'Y'));
