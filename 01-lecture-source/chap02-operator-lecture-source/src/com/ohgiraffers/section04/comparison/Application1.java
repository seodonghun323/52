...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 연산자 중 참 혹은 거짓을 반환하는 연산자는 삼항연산자의 조건식이나 조건문의 조건설에 많이 사용된다
        * (충분히 연습이 필요함!)*/
...
//         */
        ...
        System.out.println("dnum1과 dnum2가 크거나 같은지 비교" + (dnum1 >=dnum2));
        ...
        System.out.println("ch1과 ch2가 크거나 같은지 비교" + (ch2 >=ch2));
        System.out.println("ch1과 ch2가 작은지 비교" + (ch2 < ch2));
        System.out.println("ch1과 ch2가 작거나 같은지 비교" + (ch2 <= ch2));
...
//        System.out.println("bool1이 bool2보다  큰지 비교 :" + (bool1 > bool2));
        ...
        System.out.println("st1과 str2가 같은지 비교" +(str1 == str2));
        System.out.println("st1과 str2가 다른지 비교" +(str1 != str2));
        //System.out.println("st1과 str2가 큰지 비교" +(str1 < str2));
